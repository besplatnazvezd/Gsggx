...
# ВПИШИ СЮДА СВОИ РЕКВИЗИТЫ И ИНСТРУКЦИИ ДЛЯ P2P-ПОПОЛНЕНИЯ (Отображается пользователю)
P2P_PAYMENT_INSTRUCTIONS = (
    "1️⃣ *Переведите игровую валюту на реквизиты администрации:*\n"
    "🔗 Если оплата происходит ссылкой, то отправьте сюда ссылку, если оплата прямо в игре, то напишите администратору\n"
    "💳  ЮMoney: [4100119121976236]\n"
    "🎮 ID / Ник в игре (для прямого обмена): [ТВОЙ_ИГРОВОЙ_ID_ИЛИ_НИКНЕЙМ_В_НЕКСТ_ЛАЙН]\n"
    "💬 Telegram админа для связи: tg://user?id=@[nmproda])\n\n" # Убедись, что это ссылка на твой АДМИН_ID или юзернейм
    "2️⃣ СДЕЛАЙТЕ СКРИНШОТ / ССЫЛКУ / ВАШ НИКНЕЙМ и отправьте мне (боту) в СЛЕДУЮЩЕМ сообщении!\n"
    "Я отправлю его админу для проверки.\n\n"
    "⚠️ *Напоминание по курсу:* Админ проверит поступление, умножит количество полученной валюты на коэффициент 1.40 и начислит эквивалент в NMP.\n\n"
    "⏳ *Срок проверки:* обычно от 5 до 30 минут."
)
